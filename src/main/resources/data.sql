...
INSERT INTO users (birth_date, email, email_verified, gender, name, phone_number, phone_verified, profile_picture,
                   profile_verified, type)
VALUES ('2018-12-03', 'darth_vader@gmail.com', 'true', 'Masculino', 'Darth Vader', '(42)9 9999-9999', 'true','https://i.imgur.com/owhNAKK.png', 'true', 'profissional'),
       ('2018-12-03', 'chewbacca@gmail.com', 'false', 'Masculino', 'Chewbacca', '', 'false', '', 'true', 'profissional'),
       ('2018-12-03', 'joao@gmail.com', 'false', 'Masculino', 'Joao', '', 'false', '', 'true','profissional'),
       ('2018-12-03', 'ana@gmail.com', 'false', 'Feminino', 'Ana', '', 'false', '', 'true','profissional');

INSERT INTO professionals (cpf, description, rating, denounce_amount, id)
VALUES ('222222222', 'Sua falta de fé é perturbadora.', '5', '1', '1'),
       ('111111111', '', '1', '2', '2'),
       ('222222423', 'Viva intensamente.', '5', '1', '3'),
       ('222222223', 'A vida é feita de obstaculos.', '5', '1', '4');
...
INSERT INTO job_requests (client_confirmation, date_created, date_expired, description, professional_confirmation,
...
VALUES ('true', '2018-12-03', '2018-12-03', 'Lorem ipsum dolor', 'true', '3', 'CLOSED', '2', '1'),
       ...
       ('true', '2018-12-03', '2018-12-03', 'Lorem ipsum dolor', 'true', '3', 'CLOSED', '1', '2'),
       ('true', '2018-12-03', '2018-12-03', 'Preciso de alguém para formartar meu pc', 'true', '3', 'CLOSED', '1', '4'),
       ('true', '2018-12-03', '2018-12-03', 'Meu pc não liga', 'true', '3', 'CLOSED', '1', '4');
...
VALUES (1,  1, 'false', '2018-12-03', 'false' ),
       ...
       (7,  3, 'false', '2018-12-03', 'false' ),
       (7,  4, 'false', '2018-12-03', 'false' );
