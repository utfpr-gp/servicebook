               ...
               <div class="container">
                   <div class="row">
                        <div class="col s12 m4 center">
                            ...
                            <c:if test="${user.profilePicture != null}">
                                <div class="row">
                                    <img src="${user.profilePicture}" alt="Profissional - Imagem de perfil." style="width:200px;height:200px"/>
                                </div>
                            </c:if>
                           <h5 class="center edit-link tertiary-color-text"><a class="tertiary-color-text" href="">Editar foto</a></h5>
                        </div>
                        <div class="col s12 m8">
                            <h3 class="center secondary-color-text"><strong>${user.name}</strong></h3>
                            <h5 class="center secondary-color-text"><i class="small material-icons">email</i> ${user.email}</h5>
                            <h5 class="center secondary-color-text"><i class="small material-icons">local_phone</i> ${user.phoneNumber}</h5>
                            <h5 class="center secondary-color-text"><i class="small material-icons">location_on</i> ${user.address.neighborhood}, ${city.name} - ${city.state.uf}</h5>
                       </div>
                   </div>
               </div>
           </div>
