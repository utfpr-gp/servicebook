            ...
            <div class="col s12 spacing-buttons">
                <div class="none-profission center">
                    ...
                    <p class="center text-form-dados">
                        Nenhuma solicitação para orçamento encontrada!
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div>
                        <div class="row no-margin center">
                            <div class="col l2 offset-l8 spacing-buttons center">
                                <div class="center">
                                    <a href="#modal-delete" data-url="${pageContext.request.contextPath}/minha-conta/meus-pedidos/${job.jobRequest.id}" data-name="${job.jobRequest.description}" class="waves-effect waves-light btn modal-trigger">Excluir</a>                                                        </div>
                            </div>
                            <div class="col l2 spacing-buttons center">
                                <div class="center">
                                    <a class="waves-effect waves-light btn" href="minha-conta/meus-pedidos/${job.jobRequest.id}">Ver</a>
                                </div>
                            </div>
                        </div>
                    </div>
