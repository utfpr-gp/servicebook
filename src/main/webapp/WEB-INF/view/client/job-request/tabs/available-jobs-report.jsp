                ...
                <div class="col s12">
                    <div class="row no-margin">
                        <div class="col s6 m6 l2 offset-l8 spacing-buttons center">
                            <div class="center">
                                <a href="#modal-delete" data-url="${pageContext.request.contextPath}/minha-conta/cliente/meus-pedidos/${jobRequest.id}" data-name="${jobRequest.description}" class="waves-effect waves-light btn modal-trigger">Excluir</a>                                                        </div>
                        </div>
                        <div class="col s6 m6  l2 spacing-buttons center">
                            <div class="center">
                                <a class="waves-effect waves-light btn" href="minha-conta/cliente/meus-pedidos/${jobRequest.id}">Ver</a>
                            </div>
                        </div>
                    </div>
                </div>
