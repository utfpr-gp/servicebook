...
<div class="col s12">
  <span class="left-align" style="font-weight: bold">Pacote de Serviços</span>
  <a href="minha-conta/profissional/meus-anuncios/pacotes" class="btn-flat" style="float: right">ver mais</a>
</div>
